...
#external_menu="dmenu -l 30 -sb '$color1' -sf '$background'"
#external_menu="dmenu -l 30 -sb '$color1' -sf '$background'"
external_menu="dmenu -sb '$color4' -sf '$color0' -nf '$color4' -nb '$color0' -l 20 -Y 20 -W 1000 -bw 1"
...
#(YTFZF_EXTMENU_LEN)
#external_menu_len=150
external_menu_len=150

#the player to use for playing the video, must be able to stream from youtube-dl
#vlc also works
#(YTFZF_PLAYER)
video_player="nohup umpv"
#video_player="nohup "umpv --detach --hwdex=API""
